...
import logging
import inflect
from ckanext.hack4laatd.helpers import toolkit, model
log = logging.getLogger(__name__)


def process_package(package, existing_package, harvest_object):
    from ckanext.hack4laatd.harvest import processors
...
def map_package(package, mapping):
    # mapping: in form of `{'hack4laatd_field_name: ['key_1', 'key_2', ...], ...}`
